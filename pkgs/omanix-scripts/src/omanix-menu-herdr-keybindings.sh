...
# omanix:summary=Display annotated Herdr keybindings using an interactive search menu.
# omanix:args=[--print|-p] [--config <path>]
...
# Omanix seed config here would describe bindings Herdr never loaded.
...
output_keybindings | omanix-menu-dmenu -p 'Herdr keybindings' --width 800 >/dev/null || true
