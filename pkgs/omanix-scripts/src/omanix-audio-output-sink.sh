...
# omanix:summary=Print the sink whose volume and mute a given output really uses
# omanix:args=[sink-name]
# omanix:examples=omanix-audio-output-sink | omanix-audio-output-sink omanix_speaker_tuning
