...
# omanix:summary=Return a formatted weather status string with temperature and wind speed
# omanix:examples=omanix-weather-status

place=$(omanix-weather-location 2>/dev/null)
