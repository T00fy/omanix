...
- [ ] Extend `lib/themes.nix` / theme resolution to emit, per theme, a `shell.toml` into the store, in the format the QML shell consumes (colors.toml done above). Reuse the existing palette (color0-15 + semantic already present).
