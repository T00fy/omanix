...
// Visual reference + live playground for omanix-shell's common UI
// components. Summon with `omanix dev ui-preview`, or directly via:
//   omanix-shell shell summon omanix.dev-gallery "{}"
//
...
Item {
  ...
  function open(payloadJson) {
    ...
    // Optional { section: "button" } in the payload lets `omanix dev
  ...
  function requestClose() {
    if (shell && typeof shell.hide === "function") shell.hide("omanix.dev-gallery")
  ...
  FloatingWindow {
    id: window
    title: "Omanix shell – dev gallery"
    ...
    onVisibleChanged: {
      if (!visible && !root.closingFromHost && root.shell && typeof root.shell.hide === "function")
        root.shell.hide("omanix.dev-gallery")
    }
          ...
          Column {
            ...
            Text {
              text: "Style.font.* is the shell-wide type scale. Themes ship a single "
                ...
                + "set it with `omanix font set <name>`."
            ...
            BorderSurface {
              ...
              Column {
                ...
                Dropdown {
                  ...
                  label: "Center anchor"
                  fontFamily: root.fontFamily
                  options: ["omanix.clock", "omanix.weather", "omanix.power"]
              ...
              Column {
                ...
                SearchableDropdown {
                  ...
                  options: [
                    ...
                    { value: "omanix.power", label: "Power", description: "Charge level + power profile" },
                    ...
                    { value: "omanix-menu", label: "Omanix menu", description: "Launcher / system menu" },
