...
Item {
  ...
  // Injected by omanix-shell; defaults to the session OMANIX_PATH.
  property string omanixPath: Quickshell.env("OMANIX_PATH")
  property string stateHome: Quickshell.env("HOME") + "/.local/state"
  property string imageDirs: Quickshell.env("OMANIX_IMAGE_SELECTOR_DIRS") || Quickshell.env("OMANIX_IMAGE_SELECTOR_DIR") || Quickshell.env("OMANIX_STOCK_BACKGROUNDS_DIR") || (stateHome + "/omanix/current/theme/backgrounds")
  property string imageRows: ""
  property string loadedImageRows: ""
  property string selectionFile: Quickshell.env("OMANIX_IMAGE_SELECTOR_SELECTION_FILE") || Quickshell.env("OMANIX_BACKGROUND_SELECTION_FILE")
  property string selectedImage: Quickshell.env("OMANIX_IMAGE_SELECTOR_SELECTED")
  ...
  function scriptPath(name) {
    return omanixPath + "/shell/plugins/image-picker/" + name
  }
  ...
  // Lifecycle hooks invoked by omanix-shell summon/hide. shell.summon(id,
  ...
  PanelWindow {
    ...
    color: "transparent"
    WlrLayershell.namespace: "omanix-image-selector"
