...
Panel {
  id: root
  moduleName: "omanix.power"
  ipcTarget: "omanix.power"
  ...
  function setProfile(profile) {
    ...
    actionProc.command = ["omanix-powerprofiles-set", root.discharging ? "battery" : "ac", profile]
  ...
  Process {
    id: batteryProc
    command: ["omanix-battery-status", "--shell"]
    stdout: StdioCollector { waitForEnd: true; onStreamFinished: root.updateKeyValue(text, "battery") }
  }

  Process {
    id: profilesProc
    command: ["omanix-powerprofiles-list", "--active-state"]
    stdout: StdioCollector { waitForEnd: true; onStreamFinished: root.updateProfiles(text) }
  }

  Process {
    id: systemProc
    command: ["omanix-system-stats"]
