...
// omanix-disk-speedtest run streams both phases and cleans up after itself,
...
Item {
  ...
  function dismiss() {
    if (shell && typeof shell.hide === "function")
      shell.hide((manifest && manifest.id) || "omanix.disk-speedtest")
    else close()
  }
  ...
  SpeedTestOverlay {
    ...
    layerNamespace: "omanix-disk-speedtest"
    title: root.diskName
    leftLabel: "READ"
    rightLabel: "WRITE"
    unit: "MB/s"
