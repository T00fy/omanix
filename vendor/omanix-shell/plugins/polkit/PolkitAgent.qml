...
Item {
  ...
  Process {
    id: laptopClosedProc
    command: ["bash", "-c", "omanix-hw-laptop-closed && echo closed || echo open"]
  ...
  PolkitAgent {
    ...
    onIsRegisteredChanged: {
      if (isRegistered) console.log("omanix polkit agent registered")
      else console.warn("omanix polkit agent is not registered; another agent may be running")
    }
  }
  ...
  PanelWindow {
    ...
    color: "transparent"
    WlrLayershell.namespace: "omanix-polkit"
